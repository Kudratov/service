...
var Wizard = {
    ...
    _createWizard: function(){
        ...
        if (o.iconFinish !== false) $("<button> ").attr("type", "submit").addClass("button wizard-btn-finish").addClass(buttonMode).addClass(o.clsFinish).html(Utils.isTag(o.iconFinish) ? o.iconFinish : $("<img>").attr('src', o.iconFinish)).appendTo(bar);
    ...
    _setHeight: function(){
        ...
        pages.children(".page-content").css("max-height", "auto");
